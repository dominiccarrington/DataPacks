...
tellraw @a [{"text":"> ","color":"dark_green","italic":true},{"text":"Originally By ","color":"white","italic":true},{"text":"[3boood_pro]","color":"green","italic":true,"hoverEvent":{"action":"show_text","value":[{"text":"Original Video"}]},"clickEvent":{"action":"open_url","value":"https://www.youtube.com/watch?v=r5rEaHPt6mw"}}]
