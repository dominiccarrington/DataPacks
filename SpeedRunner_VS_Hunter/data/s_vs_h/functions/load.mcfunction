...
tellraw @a [{"text":">","bold":false,"italic":false,"underline":false,"strikethrough":false,"obfuscated":false,"color":"dark_green"},{"text":" Run ","bold":false,"italic":false,"underline":false,"strikethrough":false,"obfuscated":false,"color":"white"},{"text":"/trigger speedrunner set 1","bold":false,"italic":false,"underline":false,"strikethrough":false,"obfuscated":false,"color":"dark_gold","clickEvent":{"action":"run_command","value":"/trigger speedrunner set 1"}},{"text":" to become the speedrunner","color":"white"}]
tellraw @a [{"text":">","bold":false,"italic":false,"underline":false,"strikethrough":false,"obfuscated":false,"color":"dark_green"},{"text":" Run ","bold":false,"italic":false,"underline":false,"strikethrough":false,"obfuscated":false,"color":"white"},{"text":"/trigger speedrunner set 2","bold":false,"italic":false,"underline":false,"strikethrough":false,"obfuscated":false,"color":"dark_gold","clickEvent":{"action":"run_command","value":"/trigger speedrunner set 2"}},{"text":" to randomally choose the speedrunner","color":"white"}]
