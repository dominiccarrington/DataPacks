...
execute if score Timer objDisplayed matches ..0 if score Shown objDisplayed matches 2 run scoreboard players set Shown objDisplayed 103

execute if score Timer objDisplayed matches ..0 if score Shown objDisplayed matches 3 run scoreboard objectives setdisplay belowName od_deaths
execute if score Timer objDisplayed matches ..0 if score Shown objDisplayed matches 3 run scoreboard players set Shown objDisplayed 100
...
execute if score Shown objDisplayed matches 103 run scoreboard players set Shown objDisplayed 3