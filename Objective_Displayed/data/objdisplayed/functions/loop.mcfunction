...
execute if score Timer objDisplayed matches ..0 if score Shown objDisplayed matches 0 run scoreboard objectives setdisplay belowName dragonsKilled
...
execute if score Timer objDisplayed matches ..0 if score Shown objDisplayed matches 1 run scoreboard objectives setdisplay belowName withersKilled
...
execute if score Timer objDisplayed matches ..0 if score Shown objDisplayed matches 2 run scoreboard objectives setdisplay belowName playersKilled
